...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Delete user data from related tables first (if any)
    // This is optional - depends on your RLS and cascade settings
    ...
    await supabaseAdmin.from("image_history").delete().eq("user_id", user.id);
